...
import org.ng12306.sql.net.mysql.AuthPacket;
import org.ng12306.sql.net.mysql.MySQLPacket;
import org.ng12306.sql.net.mysql.QuitPacket;
import org.ng12306.sql.net.mysql.SecurityUtil;

/**
 * 
* [添加说明]
* @author: lvbo
* @date: 2013-4-9 下午9:07:45
* @version: 1.0
 */
public class Authenticator implements Handler {
    ...
    public Authenticator(FrontendConnection source) {
        this.source = source;
    }
