...
public class NgSqlServerTestMain implements Runnable {
	
	private static final byte[] FIRST_BYTES = "Welcome to NgSql Server. \n".getBytes();
	
	private final ServerSocket serverSocket;
	
	private NgSqlServerTestMain(int port) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		new Thread(new NgSqlServerTestMain(12306)).start();
	}
