...
import static org.ng12306.ngsql.parser.recognizer.Token.SYS_VAR;
...
public abstract class MySQLParser {
    ...
    public MySQLParser(SQLLexer lexer) {
        this(lexer, true);
    }

    public MySQLParser(SQLLexer lexer, boolean cacheEvalRst) {
        this.lexer = lexer;
     ...
     * @throws SQLSyntaxErrorException if no token is matched
     */
    protected int match(Token... expectToken) throws SQLSyntaxErrorException {
