...
import static org.ng12306.ngsql.parser.recognizer.Token.KW_BINARY;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_CHARACTER;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_COLLATE;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_COLUMN;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_DEFAULT;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_EXISTS;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_IF;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_IGNORE;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_INDEX;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_KEY;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_KEYS;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_NOT;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_ON;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_SET;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_TABLE;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_TO;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_UNSIGNED;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_USING;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_ZEROFILL;
import static org.ng12306.ngsql.parser.recognizer.Token.LITERAL_NULL;
import static org.ng12306.ngsql.parser.recognizer.Token.LITERAL_NUM_PURE_DIGIT;
...
import org.ng12306.ngsql.parser.ast.expression.primary.literal.Literal;
...
* @date: 2013-5-26 下午12:01:50
* @version: 1.0
 */
public class MySQLDDLParser extends MySQLParser {
    protected MySQLExprParser exprParser;

    public MySQLDDLParser(SQLLexer lexer, MySQLExprParser exprParser) {
        super(lexer);
