...
import static org.ng12306.ngsql.parser.recognizer.Token.IDENTIFIER;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_AND;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_AS;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_ASC;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_BY;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_COLLATE;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_DESC;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_DISTINCT;
...
import static org.ng12306.ngsql.parser.recognizer.Token.KW_INTEGER;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_LIKE;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_NOT;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_SELECT;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_SEPARATOR;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_THEN;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_USING;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_WHEN;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_WITH;
import static org.ng12306.ngsql.parser.recognizer.Token.LITERAL_CHARS;
...
import static org.ng12306.ngsql.parser.recognizer.Token.PUNC_DOT;
...
import static org.ng12306.ngsql.parser.recognizer.Token.USR_VAR;
...
import org.ng12306.ngsql.parser.ast.expression.arithmeic.ArithmeticAddExpression;
import org.ng12306.ngsql.parser.ast.expression.arithmeic.ArithmeticDivideExpression;
import org.ng12306.ngsql.parser.ast.expression.arithmeic.ArithmeticIntegerDivideExpression;
import org.ng12306.ngsql.parser.ast.expression.arithmeic.ArithmeticModExpression;
import org.ng12306.ngsql.parser.ast.expression.arithmeic.ArithmeticMultiplyExpression;
import org.ng12306.ngsql.parser.ast.expression.arithmeic.ArithmeticSubtractExpression;
import org.ng12306.ngsql.parser.ast.expression.arithmeic.MinusExpression;
import org.ng12306.ngsql.parser.ast.expression.bit.BitAndExpression;
import org.ng12306.ngsql.parser.ast.expression.bit.BitInvertExpression;
import org.ng12306.ngsql.parser.ast.expression.bit.BitOrExpression;
import org.ng12306.ngsql.parser.ast.expression.bit.BitShiftExpression;
import org.ng12306.ngsql.parser.ast.expression.bit.BitXORExpression;
...
import org.ng12306.ngsql.parser.ast.expression.comparison.ComparisionGreaterThanExpression;
import org.ng12306.ngsql.parser.ast.expression.comparison.ComparisionGreaterThanOrEqualsExpression;
import org.ng12306.ngsql.parser.ast.expression.comparison.ComparisionIsExpression;
import org.ng12306.ngsql.parser.ast.expression.comparison.ComparisionLessOrGreaterThanExpression;
import org.ng12306.ngsql.parser.ast.expression.comparison.ComparisionLessThanExpression;
import org.ng12306.ngsql.parser.ast.expression.comparison.ComparisionLessThanOrEqualsExpression;
import org.ng12306.ngsql.parser.ast.expression.comparison.ComparisionNotEqualsExpression;
...
import org.ng12306.ngsql.parser.ast.expression.logical.LogicalNotExpression;
import org.ng12306.ngsql.parser.ast.expression.logical.LogicalOrExpression;
import org.ng12306.ngsql.parser.ast.expression.logical.LogicalXORExpression;
import org.ng12306.ngsql.parser.ast.expression.logical.NegativeValueExpression;
import org.ng12306.ngsql.parser.ast.expression.misc.AssignmentExpression;
...
import org.ng12306.ngsql.parser.ast.expression.misc.SubqueryAllExpression;
import org.ng12306.ngsql.parser.ast.expression.misc.SubqueryAnyExpression;
...
import org.ng12306.ngsql.parser.ast.expression.primary.MatchExpression.Modifier;
...
import org.ng12306.ngsql.parser.ast.expression.primary.Wildcard;
...
import org.ng12306.ngsql.parser.ast.expression.primary.function.string.Trim.Direction;
...
import org.ng12306.ngsql.parser.ast.expression.string.RegexpExpression;
import org.ng12306.ngsql.parser.ast.expression.string.SoundsLikeExpression;
import org.ng12306.ngsql.parser.ast.expression.type.CastBinaryExpression;
import org.ng12306.ngsql.parser.ast.expression.type.CollateExpression;
import org.ng12306.ngsql.parser.recognizer.MySQLFunctionManager;
...
* @date: 2013-5-26 下午12:04:51
* @version: 1.0
 */
public class MySQLExprParser extends MySQLParser {
    public MySQLExprParser(SQLLexer lexer) {
        this(lexer, MySQLFunctionManager.INSTANCE_MYSQL_DEFAULT, true, DEFAULT_CHARSET);
    }

    public MySQLExprParser(SQLLexer lexer, String charset) {
        this(lexer, MySQLFunctionManager.INSTANCE_MYSQL_DEFAULT, true, charset);
    }

    public MySQLExprParser(SQLLexer lexer, MySQLFunctionManager functionManager, boolean cacheEvalRst, String charset) {
    ...
    private Expression primaryExpression(final String consumed, String consumedUp) throws SQLSyntaxErrorException {
        ...
        case KW_VALUES:
            tempStr = lexer.stringValue();
            tempStrUp = lexer.stringValueUppercase();
            String tempStrUp2 = Token.keyWordToString(lexer.token());
    ...
    /**
     * last token consumed is {@link Token#IDENTIFIER}, MUST NOT be
     * <code>null</code>
     */
    ...
    private Pair<String, Pair<Expression, Expression>> type4specialFunc() throws SQLSyntaxErrorException {
        ...
        case KW_BINARY:
        case KW_CHAR:
            typeName = Token.keyWordToString(lexer.token());
            if (lexer.nextToken() == PUNC_LEFT_PAREN) {
                lexer.nextToken();
                exp1 = expression();
                match(PUNC_RIGHT_PAREN);
    ...
    /**
     * first token is {@link Token#KW_SELECT}
     */
