...
import static org.ng12306.ngsql.parser.recognizer.Token.KW_DESCRIBE;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_FOR;
...
import static org.ng12306.ngsql.parser.recognizer.Token.KW_OPTION;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_READ;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_SET;
import static org.ng12306.ngsql.parser.recognizer.Token.KW_SHOW;
...
import static org.ng12306.ngsql.parser.recognizer.Token.OP_ASTERISK;
...
import org.ng12306.ngsql.parser.ast.stmt.dal.DALShowStatement;
...
* @date: 2013-5-26 下午12:01:32
* @version: 1.0
 */
public class MySQLDALParser extends MySQLParser {
    protected MySQLExprParser exprParser;

    public MySQLDALParser(SQLLexer lexer, MySQLExprParser exprParser) {
        super(lexer);
